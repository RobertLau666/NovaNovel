...
1. 修改 generate_volume_chapters 函数，让它**“切片”**生成章详细大纲。（开始跑2.csv的task_id1《规则怪谈：我靠发疯带飞龙国》）
...
5. content/中加上卷文件夹
6. 加上v7，去掉“每章”、“都”等字眼，改为“可以适当”
7. 加上RANDOM_DIRECTIVE_PROMPTS，去掉单调性（但是没有使用）
8. 加上词频统计
9. 9卷-16章至9卷-20章的章详细大纲缺失了（为啥呢） 所以txt跳过生成了 检查batch章详细大纲一批生成完了吗 不够/缺失则重新生成
10. csv的“卷详细大纲”咋跑到“核心设定与人物”里了
11. 加入：尽情发挥想象力 围绕idea写卷大纲；尽情发挥想象力 在卷大纲下写章大纲
12. 加上“禁止重复”等
13. 设定中不要出现“禁止具体特指” 可以用泛指的“炫酷的音乐”代替特指的《最炫民族风》（开始跑3_20260208.csv的task_id2《赛博修仙：我靠删库跑路成圣》））
14. 修改文件夹等的名字
15. 修改README.md
